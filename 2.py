...
You may assume the input matrix is always valid, meaning that such a sort is 
always possible. 

For example for input matrix:
1 3 5
3 2 4
...
This would be a O(n lg n) time complexity where n is the number of items 
in the matrix, i.e., n = rows*cols. Can you design a more efficient algorithm? 
